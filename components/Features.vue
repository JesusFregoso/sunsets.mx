  ...
  <div class="mt-28 bg-gray-50 px-4 sm:px-10 py-12">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid lg:grid-cols-3 sm:grid-cols-2 gap-10 mt-14">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-primary mb-4 inline-block" viewBox="0 0 32 32">
                <path
              ...
              <a href="javascript:void(0);" class="text-primary-500 font-semibold inline-block mt-2 hover:underline">Learn
                more</a>
            </div>
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-primary mb-4 inline-block"
                ...
                <g fill="none" class="stroke-primary" stroke-linecap="round" stroke-linejoin="round"
            ...
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-primary mb-4 inline-block" viewBox="0 0 24 24">
            ...
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-primary mb-4 inline-block"
                ...
                <g fill="none" class="stroke-primary" stroke-miterlimit="10" stroke-width="30" clip-path="url(#a)"
                  transform="matrix(1.33 0 0 -1.33 0 682.667)">
                  <path
            ...
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-primary mb-4 inline-block" viewBox="0 0 512 512">
                <path
