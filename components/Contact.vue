...
<template>
  ...
  <div class="bg-white mt-32 px-4 py-12">
        <div class="grid sm:grid-cols-2 items-center gap-16 my-6 mx-auto max-w-5xl">
          <div>
            <h1 class="md:text-4xl text-3xl font-extrabold">Hablemos</h1>
            <p class="mt-6">¿Tienes alguna gran idea o integracion por desarrollar y necesitas ayuda? Entonces contáctanos, nos encantaría conocer tu proyecto y brindarte asistencia.</p>
            <div class="mt-12">
              <h2 class="text-xl font-semibold">Email</h2>
              <ul class="mt-4">
                <li class="flex items-center">
                  <div class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" class='text-siren-200 fill-current'
                  ...
                  <a href="javascript:void(0)" class="text-siren-100 ml-3">
                    <small class="block">Correo</small>
                    <strong>info@sunsets.mx</strong>
                  </a>
                </li>
              </ul>
            </div>
